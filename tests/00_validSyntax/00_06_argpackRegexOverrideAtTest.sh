...
echo "Purpose:"
echo "  Demonstrate argpack complex feature of allowing regex using submit options logic of override at test"

# Run various tests from json and do checks
redirect=$( mktemp $CURRENT_SOURCE_DIR/test_XXXX )
suite=00_vs_submitOptions
test0=overrideAtTest-regex
test0_step0=step
test1=basic
test1_step0=step
...
. $CURRENT_SOURCE_DIR/../scripts/helper_step_stdout.sh $result $CURRENT_SOURCE_DIR $suite $test0 $test0_step0 "arg0 arg1 overrideAtTest" true
result=$?
